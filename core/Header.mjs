...
//
        const   __set_header_model      = () =>
        {
            ...
            if (typeof global.__s16_model !== 'undefined')
                objExe.memory_model = global.__s16_model;
...
//
        const   __set_header_segments   = () =>
        {
            ...
            if (typeof global.__s16_segments !== 'undefined')
                objExe.segments = global.__s16_segments;
            if (typeof global.__s16_maxaddr !== 'undefined')
                objExe.maxaddr = global.__s16_maxaddr;
...
//
        const   __set_header_mode           = () =>
        {
            ...
            if (typeof global.__s16_mode !== 'undefined')
                objExe.memory_mode = global.__s16_mode;

            __dst_view.setUint16(global.S16_HEADER_MODE, objExe.memory_mode, global.little_endian);
