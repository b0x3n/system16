...
//
    ...
    //
            ...
            if (typeof __preprocessor.objSections[0].label === 'undefined')
                __preprocessor.objSections[0].label = [];
            
            __messenger.verbose(`  Header:           ${__preprocessor.objSections[0].label.length} total entries.\n`);
